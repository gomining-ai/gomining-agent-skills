...
Your first payment generates a new miner from the Mine Box collection with 20 W/TH energy efficiency. The miner is yours permanently, and its power grows automatically each month.
...
* Power below 1000 TH
* Energy efficiency better than 20 W/TH (e.g., 18 W/TH)
...
Each miner can only have one active subscription at a time.

---

### Payment and Billing

Only **bank card payments** are accepted. You can pay with a linked card or add a new one when subscribing.

Subscriptions with Apple Pay are no longer available.

#### What happens if my card has insufficient funds?

Your subscription will not be cancelled automatically — we'll retry charging your card. **Your bonus level is preserved** during payment issues.
...
If you cancel, your **bonus resets to 0%**. If you resubscribe later, you'll start building the bonus from the beginning.
